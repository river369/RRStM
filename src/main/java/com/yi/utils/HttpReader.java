...
//            	 List<String> keylist = headerMap.get(key);
//            	 for (String s : keylist){
// 	            	System.out.println(key+"= "+s);
// 	        	}
//            }

            List<String> ContentEncoding = headerMap.get("Content-Encoding");
            ...
            if (in == null) {
                //if(param.contains(".sell")) System.out.println("not find "+param);
                in = new BufferedReader(
